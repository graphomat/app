...
<footer class="footer">
        ...
        <div class="footer-grid">
            ...
            <div class="footer-column">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="#certification">Квалификации</a></li>
                    <li><a href="#approach">Метод DBT</a></li>
            ...
            <div class="footer-column">
                <h3>Услуги</h3>
                <ul class="footer-links">
                    <li><a href="#individual">Индивидуальная терапия</a></li>
                    <li><a href="#group">Групповой тренинг</a></li>
                    <li><a href="#online">Онлайн формат</a></li>
            ...
            <div class="footer-column">
                <h3>Расписание</h3>
                <ul class="footer-links">
                    <li><a href="#schedule">Групповые занятия</a></li>
    ...
    <div class="footer-bottom">
        <div class="footer-bottom-content">
            <div class="footer-logo">DBT Unity</div>
