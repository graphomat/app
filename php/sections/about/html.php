...
<section class="about-section" aria-labelledby="about-heading">
    <div class="about-grid">
        <div class="about-content">
            ...
            <p>В 2024 году наша команда прошла обучение диалектической поведенческой терапии от <?php echo htmlspecialchars($aboutData['certification']['institution']); ?> под
        ...
        <div class="certification-card" aria-labelledby="cert-heading">
            <a href="Cert_Unity_241108_073542.pdf" 
               aria-label="Посмотреть сертификат <?php echo htmlspecialchars($aboutData['certification']['institution']); ?>">
                <img src="img/unitydbt-cert.png" 
                     alt="Сертификат <?php echo htmlspecialchars($aboutData['certification']['program']); ?> от <?php echo htmlspecialchars($aboutData['certification']['institution']); ?>" 
                     class="certification-logo"
                     height="350">
            </a>

            <div class="certification-details">
                <h3 id="cert-heading"><?php echo htmlspecialchars($aboutData['certification']['program']); ?></h3>
                <p>
                    <span class="highlight-text">Часть 1:</span> 
                    <?php echo htmlspecialchars($aboutData['certification']['part1_dates']); ?>
                </p>
                <p>
                    <span class="highlight-text">Часть 2:</span> 
                    <?php echo htmlspecialchars($aboutData['certification']['part2_dates']); ?>
                </p>
                ...
                <div role="list" aria-labelledby="instructors-heading">
                    <?php foreach ($aboutData['instructors'] as $instructor): ?>
                        <p role="listitem">
                            <?php echo htmlspecialchars($instructor['name'] . ($instructor['title'] ? ', ' . $instructor['title'] : '')); ?>
                        </p>
                    <?php endforeach; ?>
                </div>
            </div>
