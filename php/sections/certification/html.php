...
<div class="certification-section">
    <div class="container">
        <h2 class="section-title">
            [translate key="certification_section_title" lang="<?php echo $currentLang; ?>"]
        </h2>

        <div class="section-description">
            [translate key="certification_section_description" lang="<?php echo $currentLang; ?>"]
        </div>

        <div class="certification-content">
            <div class="certification-info">
                <div class="info-text">
                    [translate key="certification_info_text" lang="<?php echo $currentLang; ?>"]
                </div>
                ...
                <?php if (!empty($certificationFile)): ?>
                    <div class="certification-document">
                        <a href="<?php echo htmlspecialchars($certificationFile); ?>" 
                           ...
                           target="_blank">
                            [translate key="certification_download_button" lang="<?php echo $currentLang; ?>"]
                        </a>
                    </div>
                <?php endif; ?>
            </div>
                    ...
                    <?php foreach ($sectionData['badges'] as $badge): ?>
                        <div class="badge-item">
                            ...
                            <h3 class="badge-title">
                                [translate key="certification_badge_<?php echo $badge['key']; ?>_title" 
                                          lang="<?php echo $currentLang; ?>"]
                            </h3>
                            <div class="badge-description">
                                [translate key="certification_badge_<?php echo $badge['key']; ?>_description" 
                                          lang="<?php echo $currentLang; ?>"]
                            </div>
                        </div>
                    <?php endforeach; ?>
